...
var extensionURL = 'https://champierre.github.io/ai_translate/ai_translate.mjs';

var Scratch3AiTranslate = /*#__PURE__*/function () {
  function Scratch3AiTranslate(runtime) {
  ...
  return Scratch3AiTranslate;
}();

var blockClass = Scratch3AiTranslate; // loadable-extension needs this line.

var _ai_translate = Scratch3AiTranslate;
_ai_translate.blockClass = blockClass;

export { _ai_translate as __moduleExports, blockClass, entry };
